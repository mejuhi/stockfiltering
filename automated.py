...
if (r.status_code == 200):
	...
	csvWriter=csv.writer(open('file/automated-output.csv','w',newline=''),delimiter = ',')
	firstline = True
	for row in csvReader:
		if firstline:
			csvWriter.writerow(row)
	...
	os.remove(fileZip)
	print ("SUCCESS: Please check processed 'file/automated-output.csv' file in your current directory")
else:
